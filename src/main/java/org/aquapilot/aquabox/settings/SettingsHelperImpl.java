...
import org.aquapilot.aquabox.settings.exception.InvalidConfigFileException;
...
public class SettingsHelperImpl implements SettingsHelper {
    ...
    public Settings loadSettings() {
        ...
        try {
            ...
            // url
            Optional<String> databaseUrl = Optional.ofNullable(ini.get(DATABASE, URL));
            ...
            return Settings
                    .newInstance()
                    .database(database)
                    .databaseUrl(databaseUrl.orElse(""))
